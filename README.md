# Matteo Biagetti - Personal Website

Personal academic website built with the [al-folio](https://github.com/alshedivat/al-folio) Jekyll theme.

## About

This website showcases my research in topological data analysis, machine learning, and theoretical physics. I am currently a researcher at the Laboratory of Data Engineering (LADE) at Area Science Park in Trieste, Italy.

## Deployment on GitHub Pages

This website is designed to be deployed on GitHub Pages at `matteo.biagetti.github.io`.

### Setup Instructions

1. **Repository Name**: This repository should be named `matteo.biagetti.github.io` (or `username.github.io` format)
...
3. **GitHub Actions**: The site automatically builds and deploys using GitHub Actions workflow (`.github/workflows/deploy.yml`)
...
5. **Access**: After successful deployment, the site will be available at `https://matteo.biagetti.github.io`
...
- Bundler
- Jekyll
- Python (for Jupyter notebook support)
...
Edit `_bibliography/papers.bib` to add or update publications. The bibliography uses BibTeX format.
...
- Replace profile picture at `assets/img/prof_pic.jpg`
- Edit about page content in `_pages/about.md`

### CV

Update CV information in `_data/cv.yml` for structured CV data.
...
- Jekyll and plugin settings

## Features

- ✅ Responsive design
- ✅ Dark/light mode
- ✅ Publication list with BibTeX
...
Refer to the [al-folio documentation](https://github.com/alshedivat/al-folio) for detailed customization options.
